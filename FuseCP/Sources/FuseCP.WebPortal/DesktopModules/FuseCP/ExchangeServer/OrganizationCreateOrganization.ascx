				...
				<div class="card-body form-horizontal">
					...
					<table>
						...
						<tr>
							...
							<td>
                            <asp:DropDownList id="ddlDomains" runat="server" CssClass="form-control align-middle" DataTextField="DomainName" DataValueField="DomainID"  OnSelectedIndexChanged="ddlDomains_Changed" AutoPostBack="true"></asp:DropDownList>
							</td>
						</tr>
					</table>
