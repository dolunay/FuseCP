                ...
                <td colspan="2">
                    ...
                    <table class="table table-borderless align-middle mb-0 fcp-mt-15" id="tableDynamicMemory" runat="server">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMinimum" runat="server" CssClass="form-control" Text=""></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMaximum" runat="server" CssClass="form-control" Text=""></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtBuffer" runat="server" CssClass="form-control" Text=""></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPriority" runat="server" CssClass="form-control" Text=""></asp:TextBox>
