...
<div class="card-body form-horizontal">
    <table class="table table-borderless align-middle mb-0 w-100">
	    ...
	    <tr>
		    <td class="SubHead align-top"><asp:Label ID="lblBackupOptions" runat="server" meta:resourcekey="lblBackupOptions" Text="Backup Options:"></asp:Label></td>
	    ...
	    <tr>
		    <td class="SubHead align-top"><asp:Label ID="lblBackupDestination" runat="server" meta:resourcekey="lblBackupDestination" Text="Backup Destination:"></asp:Label></td>
		    <td class="normal">
