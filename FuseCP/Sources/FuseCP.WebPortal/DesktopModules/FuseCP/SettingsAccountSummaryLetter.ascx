...
<table>
    ...
    <tr>
        <td class="SubHead" colspan="1"><asp:Label ID="lblFrom" runat="server" meta:resourcekey="lblFrom" Text="From:"></asp:Label></td>
    ...
    <tr>
        ...
        <td class="Normal" colspan="1">
            <asp:TextBox ID="txtCC" runat="server" CssClass="form-control"></asp:TextBox></td>
    </tr>
    <tr>
        <td class="SubHead" colspan="1"><asp:Label ID="lblSubject" runat="server" meta:resourcekey="lblSubject" Text="Subject:"></asp:Label></td>
        <td class="Normal" colspan="1">
            <asp:TextBox ID="txtSubject" runat="server" CssClass="form-control"></asp:TextBox></td>
    </tr>
    <tr>
