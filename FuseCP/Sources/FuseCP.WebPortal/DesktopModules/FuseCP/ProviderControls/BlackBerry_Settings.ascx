...
<table class="table table-borderless align-middle mb-0 w-100">
    <tr>
        <td class="SubHead text-nowrap" style="width: 200px;"><asp:Label runat="server" ID="lblPath" meta:resourcekey="lblPath" /></td>
        <td>                        
    ...
    <tr>
        <td class="SubHead text-nowrap" style="width: 200px;"><asp:Label runat="server" ID="lblPassword" meta:resourcekey="lblPassword" /></td>
        <td>                        
    ...
    <tr>
        <td class="SubHead text-nowrap" style="width: 200px;"><asp:Label runat="server" ID="lblEnterpriseServer" meta:resourcekey="lblEnterpriseServer" /></td>
        <td>                        
    ...
    <tr>
        <td class="SubHead text-nowrap" style="width: 200px;"><asp:Label runat="server" ID="lblBesAdminServiceHost" meta:resourcekey="lblBesAdminServiceHost" /></td>
        <td>                        
