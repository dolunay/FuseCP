...
<table class="table table-borderless align-middle mb-0 w-100">
    <tr>
        ...
        <tr>
        <td class="SubHead text-nowrap" ><asp:Label runat="server" ID="lblHandheldcleanupPath" meta:resourcekey="lblHandheldcleanupPath" /></td>
        <td>                        
    ...
    <tr>
        <td class="SubHead text-nowrap" ><asp:Label runat="server" ID="lblUser" meta:resourcekey="lblUser" /></td>
        <td>                        
    ...
    <tr>
        <td class="SubHead text-nowrap" ><asp:Label runat="server" ID="lblEnterpriseServerFQDN" meta:resourcekey="lblEnterpriseServerFQDN" /></td>
        <td>                        
    ...
    <tr>
        <td class="SubHead text-nowrap" ><asp:Label runat="server" ID="lblMAPIProfile" meta:resourcekey="lblMAPIProfile" /></td>
        <td>                        
