...
<table class="table table-borderless align-middle mb-0 w-100" width="100%">
		<tr>
			...
			<td width="100%"><asp:TextBox Runat="server" ID="txtUsersHome" Width="300px" CssClass="form-control" MaxLength="255"></asp:TextBox></td>
		</tr>
		<tr>
			<td class="SubHead text-nowrap">
			    <asp:Label ID="lblLogDir" runat="server" meta:resourcekey="lblLogDir" Text="Log Directory:"></asp:Label>
			</td>
			<td width="100%"><asp:TextBox Runat="server" ID="txtLogDir" Width="300px" CssClass="form-control" MaxLength="255"></asp:TextBox></td>
		</tr>
</table>
