...
<table>
    ...
    <tr>
        <td class="text-end"><asp:Label ID="Label1" meta:resourcekey="cbShowdomainaliasmenu" runat="server" /></td>
        <td>
            <asp:CheckBox runat="server" ID="cbShowdomainaliasmenu" />
        </td>
    </tr>
    <tr>
        <td class="text-end"><asp:Label ID="Label2"  meta:resourcekey="cbShowlistmenu" runat="server" /></td>
        <td>
            <asp:CheckBox runat="server" ID="cbShowlistmenu" />
        </td>
    </tr>
    <tr>
        <td class="text-end"><asp:Label ID="Label3" meta:resourcekey="cbShowspammenu" runat="server" /></td>
        <td>
            <asp:CheckBox runat="server" ID="cbShowspammenu" />
        </td>
    </tr>
    <tr>
        <td class="text-end"><asp:Label ID="Label4" meta:resourcekey="cbShowDomainReports" runat="server" /></td>
        <td>
