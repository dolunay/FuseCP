		    ...
		    <div class="Center">
                <div class="FormBody">
                    ...
                    <%--<wsp:CollapsiblePanel ID="secReplicationDetails" runat="server" Visible="False"
                        TargetControlID="ReplicationDetailsPanel" meta:ResourceKey="secReplicationDetails" Text="Health"></wsp:CollapsiblePanel> Height="0" Style="overflow:hidden;" CssClass="fcp-p-10 fcp-w-750"--%>
