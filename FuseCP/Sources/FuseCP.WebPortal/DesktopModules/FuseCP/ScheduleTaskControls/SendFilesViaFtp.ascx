<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendFilesViaFtp.ascx.cs" Inherits="FuseCP.Portal.ScheduleTaskControls.SendFilesViaFtp" %>
	<table class="table table-borderless align-middle mb-0 w-100">
        <tr>
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtFilePath" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox><br />
        ...
        <tr>
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtServer" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
        </tr>
        <tr>
            <td class="SubHead text-nowrap">
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtUserName" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
        </tr>
        <tr>
            <td class="SubHead text-nowrap">
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
        </tr>
        <tr>
            <td class="SubHead text-nowrap">
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtRemoteFolder" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
        </tr>
	</table>
