	...
	<table>
        ...
        <tr>
			<td class="SubHead">
   			...
   			<td class="Normal">
   				<asp:TextBox ID="txtBccMail" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
   			</td>
		</tr>
        ...
        <tr>
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtExpirationMailSubject" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="Normal">
   				<asp:TextBox ID="txtErrorMailSubject" runat="server" CssClass="form-control" MaxLength="1000"></asp:TextBox>
            </td>
        </tr>
