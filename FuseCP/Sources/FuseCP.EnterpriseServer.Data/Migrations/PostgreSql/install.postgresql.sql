...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260318133000_AddBruteForceProtection') THEN
    CREATE INDEX "IX_BruteForceLogs_IpAddress_Layer_AttemptTime" ON public."BruteForceLogs" ("IpAddress", "Layer", "AttemptTime");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260318133000_AddBruteForceProtection') THEN
    CREATE INDEX "IX_IpSecurityPolicies_IpRange_IsActive" ON public."IpSecurityPolicies" ("IpRange", "IsActive");
    END IF;
END $EF$;
